	...
	<dl class="slogens">
	 ...
	 <div class="seller hide">
		...
		<form id="cartForm" method="post">
			...
			<input type="hidden" class="text" id="buy-num" name="itemTitle" value="${item.title}"/>
			<input type="hidden" class="text" id="buy-num" name="itemImage" value="${item.images[0]}"/>
			<input type="hidden" class="text" id="buy-num" name="itemPrice" value="${item.price}"/>
		</form>
						</div>
					</div>
				</li>
