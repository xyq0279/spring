...
<html>
	...
	<body margin="0">
		<div id="menu_bar">
			...
			<div><a href="javascript:void(0)" target="rightFrame">> 用户管理</a></div>
			<div><a href="javascript:void(0)" target="rightFrame">> 权限管理</a></div>
			<div><a href="javascript:void(0)" target="rightFrame">> 订单管理</a></div>
