...
public class UserDaoImpl implements UserDao{
	...
	public void addUser(User user) {
		try {
			DaoUtils.update("insert into user(id,name,password,nickname,email,role) values(null,?,?,?,?,null)", user.getUsername(),user.getPassword(),user.getNickname(),user.getEmail());
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException(e);
		}
